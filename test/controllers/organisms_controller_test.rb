...
class OrganismsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organism" do
    assert_difference("Organism.count") do
      post organisms_url, params: { organism: { name: @organism.name, species: @organism.species, user_id: @organism.user_id } }
    end
  ...
  test "should update organism" do
    patch organism_url(@organism), params: { organism: { name: @organism.name, species: @organism.species, user_id: @organism.user_id } }
